...
var slopey = function() {
    ...
    function lines (data, n) {
        ...
        lines.attr({
            ...
            stroke: function(d) {
                if (d[keyValues[n+1]] > d[keyValues[n]]*(1+percentage/100)) {
                    return "#00802b";
                } else if (d[keyValues[n+1]] < d[keyValues[n]]/(1+percentage/100)) {
                    return "#af2f0c";
                } else {
                    return strokeColour;
                }
    ...
    // allow chart dimensions to be altered in "main.js" or use default value
